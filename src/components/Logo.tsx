export function HandleItRobotLogo({ size = 40 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="robotBubbleGradient" x1="40" y1="28" x2="216" y2="220" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        fill="url(#robotBubbleGradient)"
      />

      <line x1="128" y1="26" x2="128" y2="44" stroke="url(#robotBubbleGradient)" strokeWidth="10" strokeLinecap="round" />
      <circle cx="128" cy="18" r="10" fill="url(#robotBubbleGradient)" />
